...
\begin{frame}{Adding Strong Transactions}
  ...
  \begin{description}[<+->]
    ...
    \item[$\knownVC\text{[\strongcolor{\strongentry}]}$:] track the set of \strongcolor{strong} transactions replicated at this replica
    \item[$\stableVC\text{[\strongcolor{\strongentry}]}$:] track the set of \strongcolor{strong} transactions replicated at its local data center $d$
  \end{description}
